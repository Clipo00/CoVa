                    ...
                    >
                        ...
                        <td class="py-3 pl-3 pr-4 text-right sm:pr-6">
                            <div class="flex items-center justify-end space-x-1">
                                ...
                                <button type="button"
                                    @click="$store.confirm.ask({message:'{{ __('blueprint.var_remove_confirm') }}', onConfirm(){ $wire.removeVariable({{ $index }}) }})"
                                    class="text-red-600 dark:text-red-400 hover:text-red-900" title="{{ __('blueprint.var_delete_tooltip') }}">
