                ...
                @if($lockOrganization)
                    <div class="mt-1 relative">
                        <input type="text" disabled
                            ...
                            class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 shadow-sm cursor-not-allowed"
                        >
