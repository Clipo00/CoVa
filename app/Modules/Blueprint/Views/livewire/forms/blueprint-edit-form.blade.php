<div>
    <form wire:submit="submit" class="space-y-6">
        {{-- Información básica --}}
        <div x-data="{ open: true }" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200/60 dark:border-gray-700/60 overflow-hidden">
            <button type="button" @click="open = !open" class="w-full px-5 py-3 bg-indigo-50/50 dark:bg-indigo-900/20 border-b border-indigo-100 dark:border-indigo-800/30 flex items-center gap-3 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors">
                ...
                <h2 class="text-base font-semibold text-gray-900 dark:text-gray-100 text-left flex-1">{{ __('blueprint.general_info') }}</h2>
        ...
        {{-- Tags --}}
        <div x-data="{ open: true }" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200/60 dark:border-gray-700/60 overflow-hidden">
            <button type="button" @click="open = !open" class="w-full px-5 py-3 bg-purple-50/50 dark:bg-purple-900/20 border-b border-purple-100 dark:border-purple-800/30 flex items-center gap-3 hover:bg-purple-50 dark:hover:bg-purple-900/30 transition-colors">
                ...
                <h2 class="text-base font-semibold text-gray-900 dark:text-gray-100 text-left flex-1">{{ __('blueprint.tags_section') }}</h2>
                <span class="text-xs text-gray-400 hidden sm:inline">{{ __('blueprint.tags_hint') }}</span>
                <svg :class="{'rotate-180': !open}" class="h-5 w-5 text-gray-400 transform transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            </button>
        ...
        @can('publish', $blueprint)
            <div x-data="{ open: true }" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200/60 dark:border-gray-700/60 overflow-hidden">
                <button type="button" @click="open = !open" class="w-full px-5 py-3 bg-rose-50/50 dark:bg-rose-900/20 border-b border-rose-100 dark:border-rose-800/30 flex items-center gap-3 hover:bg-rose-50 dark:hover:bg-rose-900/30 transition-colors">
                    ...
                    <h2 class="text-base font-semibold text-gray-900 dark:text-gray-100 text-left flex-1">{{ __('blueprint.publish_section') }}</h2>
                    <svg :class="{'rotate-180': !open}" class="h-5 w-5 text-gray-400 transform transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
        ...
        {{-- Variables --}}
        <div x-data="{ open: true }" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200/60 dark:border-gray-700/60 overflow-hidden">
            <button type="button" @click="open = !open" class="w-full px-5 py-3 bg-emerald-50/50 dark:bg-emerald-900/20 border-b border-emerald-100 dark:border-emerald-800/30 flex items-center gap-3 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 transition-colors">
                ...
                <h2 class="text-base font-semibold text-gray-900 dark:text-gray-100 text-left flex-1">{{ __('blueprint.env_variables') }}</h2>
                <span class="text-sm text-gray-400">{{ __('blueprint.variable_count', ['count' => count($variables)]) }}</span>
                <svg :class="{'rotate-180': !open}" class="h-5 w-5 text-gray-400 transform transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            </button>
        ...
        {{-- Tabs --}}
        <div x-data="{ open: true }" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200/60 dark:border-gray-700/60 overflow-hidden">
            <button type="button" @click="open = !open" class="w-full px-5 py-3 bg-amber-50/50 dark:bg-amber-900/20 border-b border-amber-100 dark:border-amber-800/30 flex items-center gap-3 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition-colors">
                ...
                <h2 class="text-base font-semibold text-gray-900 dark:text-gray-100 text-left flex-1">{{ __('blueprint.tabs_section') }}</h2>
                <span class="text-sm text-gray-400">{{ __('blueprint.tab_count', ['count' => count($tabsConfig)]) }}</span>
                <svg :class="{'rotate-180': !open}" class="h-5 w-5 text-gray-400 transform transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            </button>
