    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">
                {{ __('blueprint.heading') }}
                @isset($totalBlueprints)
                    <span class="ml-2 inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                        {{ $totalBlueprints }}
                    </span>
                @endisset
            </h1>
