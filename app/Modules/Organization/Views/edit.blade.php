    ...
    <div class="max-w-2xl mx-auto">
        ...
        <form method="POST" action="{{ route('organizations.update', $organization->slug) }}" class=" bg-white dark:bg-gray-800 p-6 rounded-lg shadow space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $organization->name) }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="{{ __('organization.name_placeholder') }}" required>
