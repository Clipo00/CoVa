        ...
        <div x-data x-reveal>
            ...
            @if (Route::has('register'))
                <a href="{{ route('register') }}"
                   class="inline-flex items-center px-8 py-4 text-lg font-semibold text-indigo-700 bg-white hover:bg-indigo-50 rounded-xl transition-all shadow-xl shadow-indigo-900/25 hover:shadow-indigo-900/40 scale-100 hover:scale-[1.03] active:scale-[0.97]">
